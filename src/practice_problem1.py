...
class Box(object):
    ...
    def __init__(self, contents, volume):
        ...
        self.unchanged_volume = volume
        self.contents = contents
        self.volume = volume
        if self.volume < len(self.contents):
            self.contents = ''
        self.unchanged_contents = self.contents
        self.his = []
    ...
    def double(self):
        ...
        back = self.append_string(self.contents)
        return back
    ...
    def shrink(self, new_volume):
        ...
        if new_volume < len(self.contents):
            for k in range(new_volume):
                returns = returns + box[k]
                self.contents = returns
            for k in range(new_volume, len(box)):
                back = back + box[k]
    ...
    def double_then_shrink(self, new_volume):
        ...
        delta = abs(len(box) - len(self.contents))
        return delta
    ...
    def reset(self):
        ...
        self.contents = self.unchanged_contents
        self.volume = self.unchanged_volume
    ...
    def steal(self, other_box):
        ...
        other_box.contents = other_box.shrink(self.volume - len(self.unchanged_contents))
        other_box.volume = other_box.unchanged_volume
    ...
    def combined_box(self, other_box):
        ...
        q = other_box.volume + self.volume
        b = Box(p, q)
        return b
